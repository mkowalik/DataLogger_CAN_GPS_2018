...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        spinBox_RPM->setObjectName(QString::fromUtf8("spinBox_RPM"));
        ...
        sliderRPM->setObjectName(QString::fromUtf8("sliderRPM"));
        ...
        spinBox_CLT->setObjectName(QString::fromUtf8("spinBox_CLT"));
        ...
        sliderCLT->setObjectName(QString::fromUtf8("sliderCLT"));
        ...
        doubleSpinBox_battVoltage->setObjectName(QString::fromUtf8("doubleSpinBox_battVoltage"));
        doubleSpinBox_battVoltage->setDecimals(1);
        doubleSpinBox_battVoltage->setMaximum(20.000000000000000);
        doubleSpinBox_battVoltage->setSingleStep(0.100000000000000);
        doubleSpinBox_battVoltage->setValue(10.000000000000000);

        gridLayout->addWidget(doubleSpinBox_battVoltage, 2, 1, 1, 1);

        sliderBatt = new QSlider(Widget);
        sliderBatt->setObjectName(QString::fromUtf8("sliderBatt"));
        ...
        spinBox_FuelLevel->setObjectName(QString::fromUtf8("spinBox_FuelLevel"));
        ...
        sliderFuel->setObjectName(QString::fromUtf8("sliderFuel"));
        ...
        doubleSpinBox_oilPres->setObjectName(QString::fromUtf8("doubleSpinBox_oilPres"));
        doubleSpinBox_oilPres->setDecimals(1);
        doubleSpinBox_oilPres->setMaximum(12.000000000000000);
        doubleSpinBox_oilPres->setSingleStep(0.100000000000000);
        doubleSpinBox_oilPres->setValue(2.000000000000000);

        gridLayout->addWidget(doubleSpinBox_oilPres, 4, 1, 1, 1);

        sliderOil = new QSlider(Widget);
        sliderOil->setObjectName(QString::fromUtf8("sliderOil"));
        ...
        spinBox_Gear->setObjectName(QString::fromUtf8("spinBox_Gear"));
        spinBox_Gear->setMaximum(5);

        gridLayout->addWidget(spinBox_Gear, 5, 1, 1, 1);

        lcdGear = new QLCDNumber(Widget);
        lcdGear->setObjectName(QString::fromUtf8("lcdGear"));
